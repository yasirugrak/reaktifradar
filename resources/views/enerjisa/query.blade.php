...
@if(!$account->client_secret)<div class="notice">Sorgulamadan önce <a href="{{ route('enerjisa.settings') }}">Ölçüm servisi erişim bilgilerini kaydedin</a>.</div>@endif
